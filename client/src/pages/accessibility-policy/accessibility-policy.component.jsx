...
const AccessibilityPolicyPage = () => (
  <TextSection heading="Accessibility Policy">
    <h3>
    ...
    <p>
      ...
      evaluate ways to accommodate all of our customers and our overall accessibility
      policies. Additionally, while we do not control such vendors, we strongly
      encourage vendors of third-party digital content to provide content that
